...
export default function Services () {
    ...
    return (
        ...
        <section>
            ...
            <article className="d-flex flex-md-row flex-md-wrap flex-lg-nowrap flex-column flex-lg-row justify-content-center align-items-sm-center align-items-stretch gap-3 mt-5 mb-5 col-12 col-md-12 col-lg-12"> 
